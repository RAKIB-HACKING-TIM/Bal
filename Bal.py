...
psb('\033[1;97m[\033[92;1m•\033[1;97m]\033[1;97m🥰WELCOME MY TOOLS🥰  '+name)
print('')
print('\033[1;93m💥TOOLS UPDATE SUCCESSFUL 💥')
print('')
...
\033[1;92#     # #     # #    # ### ######     
 ...
 |\033[1;97m[\033[1;92m❯\033[1;97m]\033[97;1mTOOLS     \033[1;31m:  \033[1;34mFREE RANDOM❤️\033[1;92m/\033[38;5;208mV1.5✅     \033[38;5;46m|
...
def main():
    ...
    print(f"\033[1;97m[\033[92;1m1\033[1;97m]\033[1;97mRANDOM BD CLONE 1️⃣ ")
    print(f"\033[1;97m[\033[92;1m2\033[1;97m]\033[1;97mRANDOM PK CLONE 2️⃣  ")
    print(f"\033[1;97m[\033[92;1m4\033[1;97m]\033[1;97mCONTACT TO ADMIN  4️⃣")
...
def sh6():
  ...
  #  linex()
    ...
    banner()
    print(f"")
    print(f'{P}[{H}√{P}] EXAMPLE    : {K}1000/9999/5000/10000/20000')
    print(f"")
...
def sh7():
    ...
    banner()
    print(f"")
    print(f'    {P}[{H}√{P}] EXAMPLE    : {K}9999/5000/10000/20000')
    print(f"")
    limit = int(input(f'    %s[%s?%s] CRACK ID LIMIT : %s'%(N,K,N,H)))
    for nmbr in range(limit):
...
def m(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdouRAKIB-OKf'\r    {P}[{animasi}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}]{P}[{H}%s{P}] \r'%(loop,tl,len(ok))),
        sys.stdout.flush()
    except:
        pass
